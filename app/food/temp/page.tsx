  ...
  return (
    <div className="bg-white border text-[#03383f] justify-center w-full p-10 ">
      <div className="flex-col justify-center ">
        ...
        >
          <img
            src="https://cdn.sanity.io/images/yg2dvvx6/production/cc4cc8e48b6df1805dc37deba3d6050aa87e55ac-1536x1536.jpg?fm=webp&fit=min&h=450&w=450&dpr=1&q=80"
            alt="food"
          ...
          <div
            className="text-left content-center my-10 text-3xl sm:w-1/3 
                             sm:mx-10 sm:m-auto"
          >
            <h1 className="stroke-1">The Rowse Breakfast Sandwich</h1>
          </div>
        </div>
        ...
        <div className="flex flex-col -mx-10 mt-10  p-10 justify-center bg-[#fef8e6] sm:flex-row sm:p-5">
          <div className="space-y-3 sm:w-1/2 sm:m-10 sm:mt-5">
            ...
            <p>
              Rich and flaky croissant, smoky bacon, buttery scrambled egg, and
              a squeeze of Rowse Fusion Chilli honey make up this
              un-bee-lievably indulgent breakfast sandwich. The dream way to
              kick-start a weekend.
            </p>
          </div>
          <div className="space-y-3  mt-10 sm:w-1/2 sm:m-10 sm:mt-5 sm:ml-10">
            ...
            <ul className="space-y-2">
              <li>2 croissants</li>
              <li>2 tbsp of Rowse Chilli Fusion honey</li>
              <li>4 rashers of smoked streaky bacon</li>
              <li>1 avocado</li>
              <li>4 free range eggs</li>
              <li>Handful of grated cheddar</li>
